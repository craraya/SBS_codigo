VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Metodologia_Maxima_Prod 
   Caption         =   "::::: Metodologia Maxima Produccion"
   ClientHeight    =   9660.001
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   13005
   OleObjectBlob   =   "Metodologia_Maxima_Prod.frx":0000
   StartUpPosition =   1  'Centrar en propietario
End
Attribute VB_Name = "Metodologia_Maxima_Prod"
...
If (Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE DE CARGA" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE ESCOLAR" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE TURISMO" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "COLECTIVO" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "BUSES" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "MICROBUSES" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "LIEBRES" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "RADIO TAXI" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TAXI") _
And (txt_lubricantes = 0 Or txt_neumaticos = 0 Or txt_afinamientos = 0 Or txt_patentes_seguros = 0 Or txt_planilla_dia = 0 Or txt_peaje = 0 Or txt_lubricantes = "" Or txt_neumaticos = "" Or txt_afinamientos = "" Or txt_patentes_seguros = "" Or txt_planilla_dia = "" Or txt_peaje = "") Then

'MsgBox "Falta ingresar datos para la actividad transporte seleccionada", vbCritical
...
Val(txt_neumaticos) + Val(txt_afinamientos) + Val(txt_patentes_seguros) + Val(txt_otros_costos_fijos) + Val(txt_impuesto) + Val(txt_planilla_dia) + Val(txt_peaje)) * 1.15)
...
If Val(txt_mto_bruto_sol_cliente) * 1 >= 0 And Val(txt_cuota_credito) * 1 >= 0 _
   And (txt_cuota_credito) * 1 <= (txt_capacidad_pago_promedio_corregida_ajustada) * 1 Then
...
If Val(txt_mto_bruto_sol_cliente) * 1 >= 0 And Val(txt_cuota_credito) * 1 >= 0 _
       And Val(txt_mto_bruto_sol_cliente) * 1 <= (txt_monto_maximo_credito) * 1 Then
...
Else
    MsgBox ("Antes de Calcular Deben Estar Los Valores En Campos Correspondientes")
...
MsgBox "El Precio Venta Debe Ser Mayor a cero / Precio Venta Mayor a Materia Prima / Incidencias Diferente A Blanco "
...
If Val(txt_incidencia_ventas1) + Val(txt_incidencia_ventas2) + Val(txt_incidencia_ventas3) >= 80 And Val(txt_incidencia_ventas1) + Val(txt_incidencia_ventas2) + Val(txt_incidencia_ventas3) <= 100 Then
    'Prender siguiente Boton Calculo
    cmd_calcular_vta_total_mes_al_me_ba.Enabled = True
    
'''suma incidencias al estar correctas
txt_total_incidencias = Val(txt_incidencia_ventas1) + Val(txt_incidencia_ventas2) + Val(txt_incidencia_ventas3)

Else
 MsgBox "Las Incidencias Deben Estar entre 80 y 100%"
...
txt_venta_total_mensual = (txt_precio_venta1 * txt_cantidad1) + (txt_precio_venta2 * txt_cantidad2) + (txt_precio_venta3 * txt_cantidad3)

txt_venta_total_alto = Int(txt_venta_total_mensual * txt_080)
txt_venta_total_medio = Int(txt_075 * txt_venta_total_mensual)
txt_venta_total_bajo = Int(txt_060 * txt_venta_total_mensual)

txt_venta_total_max_corregida = Int(txt_venta_total_mensual / ((Val(txt_incidencia_ventas1) + Val(txt_incidencia_ventas2) + Val(txt_incidencia_ventas3)) / 100)) 'Tercer Cambio EBARRIA
txt_venta_total_mes_alto_corregida = Int(txt_venta_total_alto / ((Val(txt_incidencia_ventas1) + Val(txt_incidencia_ventas2) + Val(txt_incidencia_ventas3)) / 100))
txt_venta_total_mes_medio_corregida = Int(txt_venta_total_medio / ((Val(txt_incidencia_ventas1) + Val(txt_incidencia_ventas2) + Val(txt_incidencia_ventas3)) / 100))
txt_venta_total_mes_bajo_corregida = Int(txt_venta_total_bajo / ((Val(txt_incidencia_ventas1) + Val(txt_incidencia_ventas2) + Val(txt_incidencia_ventas3)) / 100))
...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Metodologia_Maxima_Prod.Hide
Credito_Consumo.Show
End Sub

Private Sub cmd_guardar_evaluacion_Click()

txt_metodologia_utilizada = "Maxima Produccion"
...
' La conexión a la base de datos
   ...
   '-------------------------------------------------
    ...
    'txt_fecha_agendada = REPLACE(txt_fecha_agendada, "-", "/")
...
' SELECCIONA NUMERO DE SOLICITUD ASIGNADA A CLIENTE
    ...
    ssql = "INSERT INTO TBL_MICRO_METODOLOGIA_MAXIMA_PRODUCCION " _
& " ([RUT_CLIENTE], [n_solicitud], [DV]," _
& " [producto1],[producto2],[producto3],[precio_venta1],[precio_venta2],[precio_venta3],[cantidad_unidades1],[cantidad_unidades2],[cantidad_unidades3],[materia_prima1],[materia_prima2],[materia_prima3],[mano_obra1],[mano_obra2],[mano_obra3],[incidencia_ventas1],[incidencia_ventas2],[incidencia_ventas3],[r_cvcmo1],[r_cvcmo2],[r_cvcmo3],[r_cvsmo1],[r_cvsmo2],[r_cvsmo3],[r_cvppcmo1],[r_cvppcmo2],[r_cvppcmo3],[r_cvppsmo1],[r_cvppsmo2],[r_cvppsmo3],[r_Subtotal_costo_variable],[r_Subtotal_x1_costo_variable],[r_venta_total_mensual]," _
& " [r_venta_total_alto],[r_venta_total_medio],[r_venta_total_bajo],[r_venta_total_max_corregida],[r_venta_total_alto_corregida],[r_venta_total_medio_corregida],[r_venta_total_bajo_corregida],[arriendo_micro],[sueldos],[movilizacion],[servicios_basicos],[contador],[lubricantes],[neumaticos],[afinamientos],[patentes_seguros],[otros_costos_fijos],[total_costos_fijos],[valor_uf],[n_grupo_familiar],[arriendo_vivienda_Gastos_Fam],[gastos_indicado_cliente],[total_gasto_familiar],[liquidacion_sueldo],[jubilacion],[montepio],[arriendo_vivienda_Otro_Ing],[ingreso_segunda_microempresa],[boleta_honorario],[total_otros_ingresos]," _
...
& " VALUES (('" & txt_rut_cliente & "'),('" & txt_n_solicitud & "'),('" & txt_dv & "'),('" & txt_producto1 & "'),('" & txt_producto2 & "'),('" & txt_producto3 & "'),('" & txt_precio_venta1 & "'),('" & txt_precio_venta2 & "'),('" & txt_precio_venta3 & "'),('" & txt_cantidad1 & "'),('" & txt_cantidad2 & "'),('" & txt_cantidad3 & "'), ('" & txt_materia_prima1 & "'),('" & txt_materia_prima2 & "'),('" & txt_materia_prima3 & "'),('" & txt_mano_obra1 & "'),('" & txt_mano_obra2 & "'),('" & txt_mano_obra3 & "')" _
& ",('" & txt_incidencia_ventas1 & "'),('" & txt_incidencia_ventas2 & "'),('" & txt_incidencia_ventas3 & "'),('" & txt_r_cvcmo1 & "'),('" & txt_r_cvcmo2 & "'),('" & txt_r_cvcmo3 & "'),('" & txt_r_cvsmo1 & "'),('" & txt_r_cvsmo2 & "'),('" & txt_r_cvsmo3 & "'),('" & txt_r_cvppcmo1 & "'),('" & txt_r_cvppcmo2 & "'),('" & txt_r_cvppcmo3 & "'),('" & txt_r_cvppsmo1 & "'),('" & txt_r_cvppsmo2 & "'),('" & txt_r_cvppsmo3 & "'),('" & txt_Sub_Total & "'),('" & txt_Sub_Total_x1 & "'),('" & txt_venta_total_mensual & "'),('" & txt_venta_total_alto & "'),('" & txt_venta_total_medio & "'),('" & txt_venta_total_bajo & "') " _
& ",('" & txt_venta_total_max_corregida & "'),('" & txt_venta_total_mes_alto_corregida & "'),('" & txt_venta_total_mes_medio_corregida & "'),('" & txt_venta_total_mes_bajo_corregida & "'),('" & txt_arriendo_micro & "'),('" & txt_sueldos & "'),('" & txt_movilizacion & "'),('" & txt_servicios_basicos & "'),('" & txt_contador & "'),('" & txt_lubricantes & "'),('" & txt_neumaticos & "'),('" & txt_afinamientos & "'),('" & txt_patentes_seguros & "'),('" & txt_otros_costos_fijos & "'),('" & txt_total_costos_fijos & "'),('" & txt_valor_uf & "'),('" & txt_n_grupo_familiar & "'),('" & txt_arriendo_vivienda & "'),('" & txt_gastos_indicado_cliente & "'),('" & txt_total_gasto_familiar & "'),('" & txt_liquidacion_sueldo & "'),('" & txt_jubilacion & "'),('" & txt_montepio & "'),('" & txt_arriendo_vivienda1 & "'),('" & txt_ingreso_segunda_microempresa & "'),('" & txt_boleta_honorario & "'),('" & txt_total_otros_ingresos & "'),('" & txt_acreedor1 & "'),('" & txt_acreedor2 & "'),('" & txt_acreedor3 & "')" _
...
Metodologia_Maxima_Prod.PrintForm
End Sub
...
Estado_Resolucion_Final.TXT_ESTADO_METODOLOGIA_OCUPADA = "Máxima Producción"
...
''''trae el ultimo nuemro de solicitud del evaluado
...
Estado_Resolucion_Final.txt_r_f_deuda_sbif_declarada = Metodologia_Maxima_Prod.txt_r_sbif_declarada
Estado_Resolucion_Final.txt_r_f_nivel_vta_inf_min = Metodologia_Maxima_Prod.txt_r_venta_total_min
Estado_Resolucion_Final.txt_r_f_nivel_vta_sup_max = Metodologia_Maxima_Prod.txt_r_venta_total_max
Estado_Resolucion_Final.txt_r_f_capacidad_pago = Metodologia_Maxima_Prod.txt_r_capacidad_pago
Estado_Resolucion_Final.txt_r_f_costo_fijo_rub_trasp = Metodologia_Maxima_Prod.txt_valida_costos_fijos
Estado_Resolucion_Final.txt_r_f_costo_variable_ponde = Metodologia_Maxima_Prod.txt_r_promedio_ponderado
'Estado_Resolucion_Final.txt_r_f_compra_tot_mensual = metodologia_maxima_prod.txt_r_nota_superar60
Estado_Resolucion_Final.txt_r_f_leverage = Metodologia_Maxima_Prod.txt_r_leverage
Estado_Resolucion_Final.txt_r_f_costo_variable_ponde = Metodologia_Maxima_Prod.txt_r_promedio_ponderado
...
Metodologia_Maxima_Prod.cmd_guardar_evaluacion.Enabled = True
Metodologia_Maxima_Prod.Hide
...
Private Sub Total_Deuda_SBIF_Change()
...
Private Sub txt_afinamientos_AfterUpdate()
If (Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE DE CARGA" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE ESCOLAR" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE TURISMO") _
And (txt_lubricantes = 0 Or txt_neumaticos = 0 Or txt_afinamientos = 0 Or txt_patentes_seguros = 0) Then

txt_valida_costos_fijos = "ZG"

ElseIf (Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE DE CARGA" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE ESCOLAR" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE TURISMO") _
And (txt_lubricantes > 0 And txt_neumaticos > 0 And txt_afinamientos > 0 And txt_patentes_seguros > 0) Then
...
Private Sub txt_lubricantes_AfterUpdate()
...
Private Sub txt_nota_superar60_Change()
...
Private Sub txt_neumaticos_AfterUpdate()
If (Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE DE CARGA" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE ESCOLAR" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE TURISMO") _
And (txt_lubricantes = 0 Or txt_neumaticos = 0 Or txt_afinamientos = 0 Or txt_patentes_seguros = 0) Then
...
Private Sub txt_patentes_seguros_AfterUpdate()
If (Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE DE CARGA" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE ESCOLAR" Or Ficha_Cliente_Micro.cbx_actividad_economica_formal_servicio = "TRANSPORTE TURISMO") _
And (txt_lubricantes = 0 Or txt_neumaticos = 0 Or txt_afinamientos = 0 Or txt_patentes_seguros = 0) Then
...
If (txt_vta_formal_promedio_mes_alto * 1 * numero_meses_tipo_mes_alto * 1 + txt_vta_formal_promedio_mes_medio * 1 * numero_meses_tipo_mes_medio * 1 + txt_vta_formal_promedio_mes_bajo * 1 * numero_meses_tipo_mes_bajo * 1) / txt_valor_uf * 1 > 2400 Then
...
'If (txt_venta_total * 1 / Metodologia_Maxima_Prod.txt_valor_uf * 1) > 2400 Then
...
If (txt_venta_total * 1 / Metodologia_Maxima_Prod.txt_valor_uf * 1) < 120 Then
