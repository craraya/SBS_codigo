VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Visualizador_Met_MP 
   Caption         =   ":::::: Visualizador Metodologia Maxima Produccion"
   ClientHeight    =   11310
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   13275
   OleObjectBlob   =   "Visualizador_Met_MP.frx":0000
   StartUpPosition =   1  'Centrar en propietario
End
Attribute VB_Name = "Visualizador_Met_MP"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub cmd_visualizador_MP_Click()

        Call conectarBD

        ssql = "SELECT RUT_CLIENTE,n_solicitud, DV,producto1,producto2,producto3,precio_venta1,precio_venta2,precio_venta3,cantidad_unidades1,cantidad_unidades2,cantidad_unidades3,materia_prima1,materia_prima2,materia_prima3,mano_obra1,mano_obra2,mano_obra3,incidencia_ventas1,incidencia_ventas2,incidencia_ventas3," _
        & " r_cvcmo1,r_cvcmo2,r_cvcmo3,r_cvsmo1,r_cvsmo2,r_cvsmo3,r_cvppcmo1,r_cvppcmo2,r_cvppcmo3,r_cvppsmo1,r_cvppsmo2,r_cvppsmo3,r_Subtotal_costo_variable,r_Subtotal_x1_costo_variable,r_venta_total_mensual,r_venta_total_alto,r_venta_total_medio,r_venta_total_bajo,r_venta_total_max_corregida, " _
        & " r_venta_total_alto_corregida,r_venta_total_medio_corregida,r_venta_total_bajo_corregida,arriendo_micro,sueldos,movilizacion,servicios_basicos,contador,lubricantes,neumaticos,afinamientos,patentes_seguros,otros_costos_fijos,total_costos_fijos,valor_uf,n_grupo_familiar,arriendo_vivienda_Gastos_Fam," _
        & " gastos_indicado_cliente,total_gasto_familiar,liquidacion_sueldo,jubilacion,montepio,arriendo_vivienda_Otro_Ing,ingreso_segunda_microempresa,boleta_honorario,total_otros_ingresos,acreedor1_deuda,acreedor2_deuda,acreedor3_deuda,acreedor4_deuda,acreedor5_deuda,acreedor6_deuda,tipo_producto1_deuda," _
        & " tipo_producto2_deuda,tipo_producto3_deuda,tipo_producto4_deuda,tipo_producto5_deuda,tipo_producto6_deuda,saldo_pendiente1_deuda,saldo_pendiente2_deuda,saldo_pendiente3_deuda,saldo_pendiente4_deuda,saldo_pendiente5_deuda,saldo_pendiente6_deuda,monto_cuota1_deuda,monto_cuota2_deuda,monto_cuota3_deuda," _
        & " monto_cuota4_deuda,monto_cuota5_deuda,monto_cuota6_deuda,cuotas_pactadas1_deuda,cuotas_pactadas2_deuda,cuotas_pactadas3_deuda,cuotas_pactadas4_deuda,cuotas_pactadas5_deuda,cuotas_pactadas6_deuda,cuotas_pendientes1_deuda,cuotas_pendientes2_deuda,cuotas_pendientes3_deuda,cuotas_pendientes4_deuda," _
        & " cuotas_pendientes5_deuda,cuotas_pendientes6_deuda,prepaga_cuota1_deuda,prepaga_cuota2_deuda,prepaga_cuota3_deuda,prepaga_cuota4_deuda,prepaga_cuota5_deuda,prepaga_cuota6_deuda,total_saldo_pendiente_deuda,total_deudas,numero_meses_alto_flujo,numero_meses_medio_flujo,numero_meses_bajo_flujo," _
        & " vta_formal_promedio_mes_alto_flujo,vta_formal_promedio_mes_medio_flujo,vta_formal_promedio_mes_bajo_flujo,vta_informal_promedio_mes_alto_flujo,vta_informal_promedio_mes_medio_flujo,vta_informal_promedio_mes_bajo_flujo,Venta_Total_Promedio_Mes_Alto_flujo,Venta_Total_Promedio_Mes_medio_flujo," _
        & " Venta_Total_Promedio_Mes_bajo_flujo,resultado_operacional_alto_flujo,resultado_operacional_medio_flujo,resultado_operacional_bajo_flujo,capacidad_pago_mes_alto_flujo,capacidad_pago_mes_medio_flujo,capacidad_pago_mes_bajo_flujo,cap_pago_corregida_ajus_mes_alto_flujo,cap_pago_corregida_ajus_mes_medio_flujo," _
        & " cap_pago_corregida_ajus_mes_bajo_flujo,cap_pago_promedio_corregida_ajustada_flujo,monto_maximo_credito_flujo,cuota_credito_flujo,mto_bruto_solicitado_cliente_flujo,resolucion_credito_cuota_flujo,resolucion_credito_monto_flujo,fecha_ingreso,hora_ingreso,impuesto" _
        & " FROM TBL_MICRO_METODOLOGIA_MAXIMA_PRODUCCION" _
        ...
        & " order by n_solicitud desc"
            ...
            txt_cantidad1 = rst!cantidad_unidades1
            txt_cantidad2 = rst!cantidad_unidades2
            txt_cantidad3 = rst!cantidad_unidades3
            ...
            txt_mano_obra3_ = rst!mano_obra3
            ...
            txt_venta_total_mensual = rst!r_venta_total_mensual
            ...
            txt_venta_total_max_corregida = rst!r_venta_total_max_corregida
...
Private Sub txt_dv_ing_Change()
        ...
        & " order by n_solicitud desc"
            ...
            txt_gastos_familiares_mes_bajo = rst!total_gasto_familiar
            txt_impuesto = rst!impuesto
            txt_planilla_dia = rst!planilla_dia
            txt_peaje = rst!peaje
...
Private Sub txt_peaje_Change()
txt_peaje = Format(txt_peaje, "##,##")
End Sub

Private Sub txt_planilla_dia_Change()
txt_planilla_dia = Format(txt_planilla_dia, "##,##")
End Sub
...
Private Sub txt_venta_total_max_corregida_Change()
txt_venta_total_max_corregida = Format(txt_venta_total_max_corregida, "##,##")
End Sub
...
Private Sub txt_venta_total_mensual_Change()
txt_venta_total_mensual = Format(txt_venta_total_mensual, "##,##")
End Sub
